...
SOKOL_NUKLEAR_API_DECL struct nk_font_atlas* snk_get_atlas(void);
SOKOL_NUKLEAR_API_DECL struct nk_context* snk_get_context(void);
SOKOL_NUKLEAR_API_DECL struct sg_sampler  snk_get_font_sampler(void);
...
SOKOL_API_IMPL struct nk_font_atlas* snk_get_atlas(void) {
    return &_snuklear.atlas;
}

SOKOL_API_IMPL struct sg_sampler snk_get_font_sampler(void) {
    return _snuklear.font_smp;
}
