...
DOOM.TITLE_INTERMISSION_STYLES =
{
  brown_box =
  {
    hue1 = "#332b13",
...
function DOOM.setup()
  ...
  GAME.title_screen_asset_dir = "games/doom/data/title"
end
